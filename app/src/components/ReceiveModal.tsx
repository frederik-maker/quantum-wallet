        ...
        <div className="space-y-5">
          ...
          <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
            <div className="flex items-center gap-2 mb-3">
              ...
              <p className="text-[12px] text-zinc-400 font-mono uppercase tracking-wider">
              ...
              <div className="flex items-center gap-2 mt-2.5">
                {copied === "primary" ? (
                  <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} className="flex items-center gap-1.5">
                    ...
                    <span className="text-[12px] text-[#00e5a0] font-medium">Copied!</span>
                  </motion.div>
                ) : (
                  <div className="flex items-center gap-1.5 text-zinc-500 group-hover:text-[#0ea5e9] transition-colors">
                    ...
                    <span className="text-[12px]">Click to copy</span>
                  </div>
                )}
              </div>
            </button>
          ...
          {vaultAddress && feePayerAddress && (
            ...
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <p className="text-[11px] text-zinc-400 font-mono uppercase tracking-wider">Fee payer</p>
              </div>
              <button
              ...
              >
                <code className="text-[11px] text-zinc-500 font-mono break-all group-hover:text-zinc-300 transition-colors">
                  {feePayerAddress}
                </code>
                {copied === "fee" ? (
